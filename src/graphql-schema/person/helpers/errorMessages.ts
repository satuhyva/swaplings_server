...
export const REMOVE_PERSON_SUCCESS = 'Succesfully removed person from database.'
export const REMOVE_PERSON_DATABASE_ERROR = 'Error in removing person from database.'
export const REMOVE_PERSON_UNAUTHORIZED = 'Not authorised to remove person.'
